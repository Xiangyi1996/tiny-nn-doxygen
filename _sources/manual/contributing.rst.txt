...
- test: Directory which contains all of the doctest unitest.
...
The common directory contains small helper functions as well as the containers wrapping device memory,
